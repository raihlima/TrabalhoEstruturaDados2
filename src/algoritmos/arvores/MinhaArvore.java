...
public class MinhaArvore {
    ...
    public void inserir(int id, Chave chave) {
        if (raiz == null) {
            ...
            inserirMinhaArvore(this.raiz, n);
        }
    }

    private void inserirMinhaArvore(No aComparar, No aInserir) {
        ...
        if (aComparar == null) {
            ...
            if (aInserir.getId() < aComparar.getId()) {
                ...
                if (aComparar.getEsq() == null) {
                    ...
                    inserirMinhaArvore(aComparar.getEsq(), aInserir);
                }
                ...
                if (aComparar.getDir() == null) {
                    ...
                    inserirMinhaArvore(aComparar.getDir(), aInserir);
                }
    ...
    public void remover(int k) {
        removerMinhaArvore(this.raiz, k);
    }

    public void removerMinhaArvore(No atual, int k) {
        if (atual == null) {
            return;
            ...
            if (atual.getId() > k) {
                removerMinhaArvore(atual.getEsq(), k);

            } else if (atual.getId() < k) {
                removerMinhaArvore(atual.getDir(), k);
